...
PROJECT_GIT_URL='https://github.com/indrajitkumar/StoriesFeedAPI.git'
...
ln -s /etc/nginx/sites-available/stories_api.conf /etc/nginx/sites-enabled/stories_api.conf
